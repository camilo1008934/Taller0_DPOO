...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retorna el nombre del pais del atletada dado por parametro
	 * 
	 * @param nombreAtleta El nombre del atleta del cual se quiere conocer el pais
	 * @return El pais del atleta o en caso de no encontrarse se devuelve "Not founded".
	 */
