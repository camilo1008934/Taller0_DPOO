...
public class ConsolaOlimpicos
{
	...
	/**
	 * Le muestra el usuario el pais del atleta ingresado
	 */
	private void ejecutarPaisAtleta() {
		String nAtleta = input("Ingrese el nombre del atleta");
		String resultado = calculadora.paisAtleta(nAtleta);
		if (resultado == "Not founded") {
			System.out.println("No se ha encontrado dicho atleta");
		}else {
			System.out.println("El pais del atleta es "+ resultado);
		}
	}
